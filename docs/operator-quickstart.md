# Operator Quickstart — Community Electrical Installation

Shortest path from clone to a verified local dry-run for **ISIC 4321** (`cloud-itonami-isic-4321`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4321.git
cd cloud-itonami-isic-4321
```
...
- Blueprint governor key: `electrical-trade-governor`
- Likely source path: `src/**/electrical-trade-governor.cljc`
